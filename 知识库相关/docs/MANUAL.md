...
下载仓库中的 `安装配置文档相关/AICoding.md`，放入 AI IDE，对 AI 说"执行安装"即可。
详见 [AICoding.md](../安装配置文档相关/AICoding.md)。
...
| 文档 | 说明 |
|------|------|
| [README.md](../../安装配置文档相关/README.md) | 项目介绍（GitHub 首页） |
| [MANUAL.md](MANUAL.md) | 完整使用手册（你在这里） |
| [INSTALL.md](INSTALL.md) | AI 执行安装指南 |
| [CHANGELOG.md](../../安装配置文档相关/CHANGELOG.md) | 版本变更记录 |
