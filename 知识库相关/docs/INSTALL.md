...
# 模板文件: 安装配置文档相关/templates/settings.json.template
...
# [步骤 5] 创建全局配置
# 模板文件: 安装配置文档相关/templates/config.yaml.template
...
# 模板文件: 安装配置文档相关/templates/tdd-config.yaml.template
...
# 7.4 创建全局 Git hooks
# 模板文件: 安装配置文档相关/templates/pre-commit.template
