...
const FAST_ROUTE_TABLE = [
  ...
  // debug → pro
  { type: 'debug', complexity: '*', model: 'deepseek-v4-pro', minConfidence: 0.85 },
  // doc → flash or 4o-mini
  { type: 'doc', complexity: '*', model: 'openai-4o-mini', minConfidence: 0.85 },
  // question → 4o-mini
  { type: 'question', complexity: '*', model: 'openai-4o-mini', minConfidence: 0.85 },
  // testing → flash
