...
| L2: Local file | `.claude/exa-cache/` directory | 24 hours | Cross-session, cross-skill |
| L3: Index | `.claude/exa-cache/index.json` | 7 days | Metadata for quick lookup |
...
All kf- skills share a **centralized code knowledge cache** at `.claude/exa-cache/`:
