#!/usr/bin/env node
/**
 * kf-token-tracker v3.0 - 技能调用链路追踪 + Token成本追踪
 * 
 ...
 *   node token-tracker.cjs pre-tool  (hook: auto-capture any tool call via stdin)
 ...
 *   node token-tracker.cjs inventory  (scan all skills in .claude/skills/)
