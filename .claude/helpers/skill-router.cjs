 ...
 *
 * 用法:
 *   node .claude/helpers/skill-router.cjs --inject --stage 1 --role "前端专家"
 *   node .claude/helpers/skill-router.cjs --verify --stage 1 --team red --dir ./
 *   node .claude/helpers/skill-router.cjs --list --stage 1 --role "后端专家"
 */
...
示例:
  node .claude/helpers/skill-router.cjs --inject --stage 1 --role "前端专家"
  node .claude/helpers/skill-router.cjs --verify --stage 1 --team red --dir ./.claude-flow/hammer-workspaces/
  node .claude/helpers/skill-router.cjs --list --stage 2 --role "后端专家"`);
}
