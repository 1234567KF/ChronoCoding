#!/usr/bin/env node
/**
 * hang-state-manager.cjs — 夯执行状态持久化管理器
 *
 ...
 *   node .claude/helpers/hang-state-manager.cjs --phase stage-1 --stage coding
 *   node .claude/helpers/hang-state-manager.cjs --team-progress red stage-2 70
 *   node .claude/helpers/hang-state-manager.cjs --artifact alignment docs/red-00-alignment.md
 *   node .claude/helpers/hang-state-manager.cjs --dashboard
 *   node .claude/helpers/hang-state-manager.cjs --recovery
 *   node .claude/helpers/hang-state-manager.cjs --status
 *   node .claude/helpers/hang-state-manager.cjs --complete
 *   node .claude/helpers/hang-state-manager.cjs --handoff
 *
 * API:
