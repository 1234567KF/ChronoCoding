<p align="center">
  <a href="https://github.com/1234567KF/ChronoCoding/blob/main/.claude/docs/install/AICoding.md">
...
请访问 https://github.com/1234567KF/ChronoCoding/blob/main/.claude/docs/install/AICoding.md
严格按其中的阶段0-5完成安装配置。
...
详见 [CREDITS.md](install/CREDITS.md) 完整致谢。
...
详见 [INSTALL.md](install/INSTALL.md)
...
| [AICoding.md](install/AICoding.md) | 单文件入口（给 AI 看） |
| [MANUAL.md](install/MANUAL.md) | 完整使用手册（给人看） |
| [INSTALL.md](install/INSTALL.md) | AI 执行安装指南（给 AI 看） |
| [CHANGELOG.md](install/CHANGELOG.md) | 版本变更记录 |
| [FEATURES.md](install/FEATURES.md) | 功能特性介绍 |
| [CREDITS.md](install/CREDITS.md) | 第三方开源项目致谢 |
...
│   │
│   ├── projects/                     # 子工程
│   │   ├── monitor/                 # Token 追踪监测仪表盘
│   │   │   ├── monitor/
│   │   │   │   ├── src/server.js    # Express 服务端（端口 3456）
│   │   │   │   ├── client/          # EJS 前端页面
│   │   │   │   └── scripts/         # 运维脚本
│   │   │   └── specs/
│   │   ├── throttler/               # Token 效率研究
│   │   ├── collaborator/            # 多团队竞争评审产出
│   │   └── swarm-memory/            # 多 Agent 记忆库
│   │
│   ├── knowledge/                    # 知识库
│   │   ├── raw/                     # 原始文件（不可变）
│   │   └── wiki/                    # LLM 生成的结构化知识
...
│       ├── kf-web-search/           # 多引擎搜索
│       ├── kf-multi-team-compete/   # 多团队竞争评审（夯）
│       ├── kf-alignment/            # 对齐工作流
│       ├── kf-monitor/              # 监测者仪表盘 Skill
│       ├── kf-saver/                # 会话成本节省追踪
│       ├── kf-model-router/          # 安全路由组件
│       ├── kf-model-router/         # 多供应商模型适配器
...
见 [CONTRIBUTING.md](install/CONTRIBUTING.md)

---

## 许可

LGPL-3.0 - 详见 [install/LICENSE](install/LICENSE)
