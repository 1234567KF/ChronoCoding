 ...
 *
 * 输出: 监测者/token测评/数据/lean-ctx/YYYY-MM-DD.json
 */
...
const TEST_CASES = [
  ...
  },
  {
    id: 'ls-node-modules',
    category: 'fs',
    rawCmd: 'ls "监测者/monitor/node_modules/" 2>/dev/null || echo "(no node_modules)"',
    ctxCmd: 'lean-ctx -c "ls \\"监测者/monitor/node_modules/\\" 2>/dev/null || echo \\"(no node_modules)\\""',
