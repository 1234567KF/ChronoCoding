 ...
 *
 * 用法:
 *   node .claude/helpers/skill-validator.cjs --all              # 全量验证
 *   node .claude/helpers/skill-validator.cjs --skill kf-spec    # 单技能验证
 *   node .claude/helpers/skill-validator.cjs --skill kf-spec --test-ac  # 运行 AC 场景测试
 *   node .claude/helpers/skill-validator.cjs --list-tests        # 列出所有可用测试
 */
...
function cli() {
  ...
  console.log('  node .claude/helpers/skill-validator.cjs --all              # 全量验证');
  console.log('  node .claude/helpers/skill-validator.cjs --skill kf-spec    # 单技能验证');
  console.log('  node .claude/helpers/skill-validator.cjs --list-tests       # 列出测试用例');
}
