 ...
 *
 * 验证:
 *   node .claude/helpers/quality-signals.cjs --validate <json-file>
...
function cli() {
  ...
  console.log('  node .claude/helpers/quality-signals.cjs --validate <file>');
  console.log('  node .claude/helpers/quality-signals.cjs --list');
}
