 ...
 *
 * 用法:
 *   node .claude/helpers/review-rerun-check.cjs <review-json-path>
 *   node .claude/helpers/review-rerun-check.cjs <review-json-path> --round <N>
 *   node .claude/helpers/review-rerun-check.cjs --demo  # 演示模式
 */
...
function cli() {
  ...
  if (args.length === 0) {
    ...
    console.log('  node .claude/helpers/review-rerun-check.cjs <review-json-path>');
    console.log('  node .claude/helpers/review-rerun-check.cjs <review-json-path> --round <N>');
    console.log('  node .claude/helpers/review-rerun-check.cjs --demo');
    process.exit(0);
  }
