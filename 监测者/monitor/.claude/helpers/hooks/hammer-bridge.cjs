 ...
 *   node .claude/helpers/hammer-bridge.cjs agent-fail --team red --agent fullstack --error "stall timeout"
 *   node .claude/helpers/hammer-bridge.cjs status
 *   node .claude/helpers/hammer-bridge.cjs summary --task "Claude Code UX改进"
 *   node .claude/helpers/hammer-bridge.cjs watch --interval 30000
 *   node .claude/helpers/hammer-bridge.cjs retry --issue-id T1 --team red
 *   node .claude/helpers/hammer-bridge.cjs api-state
 */
