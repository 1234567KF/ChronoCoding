 ...
 *
 * 用法:
 *   node .claude/helpers/ac-adoption.cjs                        # 全量统计
 *   node .claude/helpers/ac-adoption.cjs --since "14 days ago"  # 时间范围
 *   node .claude/helpers/ac-adoption.cjs --json                 # JSON 输出
 *   node .claude/helpers/ac-adoption.cjs --verbose              # 详细输出
 *
 * 决策标准:
 *   采用率 > 30% → 建议会议讨论是否默认开启
